...
import 'package:sintir/Core/widgets/PaymentWithPayMob/PaymentWithPayMobBody.dart';
import 'package:sintir/Features/Subscribtion/Domain/Entities/PayMobWebViewRequirmentsEntity.dart';

class PaymentWithPayMobView extends StatelessWidget {
  const PaymentWithPayMobView({super.key, required this.requirmentsEntity});
  static const routeName = '/PaymentWithPayMobView';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: PaymentWithPayMobBody(response: requirmentsEntity.payMobResponse),
      ),
    );
  }
}
