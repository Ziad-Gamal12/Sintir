...
class CourseSubscriptionsRepoImpl implements CourseSubscibtionsRepo {
  ...
  Future<Either<Failure, void>> subscribeToCourse({
    ...
    try {
      ...
      await Future.wait([
        ...
        _addSubscriber(subscriber, _buildSubscriberReq(course.id)),
  ...
  /// Build subscriber entity from user data
  ...
  FireStoreRequirmentsEntity _buildSubscriberReq(String courseId) {
