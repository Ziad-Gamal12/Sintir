...
import 'package:sintir/Features/Support/Presentation/Views/Widgets/SupportTicketChatViewWidgets/CustomPickAndUploadMessageImage.dart';
...
class _UpdateMessageBottomSheetBodyState
  ...
  void initState() {
    super.initState();
    messageController =
        TextEditingController(text: widget.messageEntity.message);
  }
    ...
    return BlocListener<SupportChatCubit, SupportChatState>(
      listener: (context, state) {
        if (state is UpdateMessageContentSuccess) {
          CustomSnackBar.show(context,
              message: LocaleKeys.messageUpdatedSuccess,
      ...
      child: Padding(
        padding: EdgeInsets.only(
          ...
          bottom: MediaQuery.of(context).viewInsets.bottom + KVerticalPadding,
        ),
